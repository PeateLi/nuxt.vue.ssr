    ...
    submit () {
      ...
      this.$refs.loginForm.validate((valid) => {
        if (valid) {
         ...
         axios.post('http://dev.utmel.lo:8081/Utmel/Login/DevLogin?devName='+_this.formLogin.username+'&devPassword='+_this.formLogin.password)
          .then(res =>{
               console.log(res)
               if(res.data.code == 1000){
                ...
                Cookie.set('token', res.data.data.devKey)
